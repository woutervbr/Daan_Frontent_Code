...
const Filter1 = ({ DesktopDes, MobileDescription }) => {
  ...
  return (
    <>
      <div className="select-station-drop-1">
        <div onClick={toggleDropdown} className="dropdwon-1-list-1">
          Omschrijving
          <svg
        ...
        {isOpen ? (
          !isMobile ? (
            <DesktopDes handleOptionClick={handleOptionClick} />
          ) : (
            <MobileDescription handleOptionClick={handleOptionClick} />
          )
        ) : (
          "" // isOpen false
        )}
